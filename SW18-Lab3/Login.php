...
<html>
  ...
  <div id='page-wrap'>
			...
			if (isset($_POST['email'])){
				...
				if (!$mysql){
					...
					if($cont==1){
						...
						echo ("Login correcto<p><a href='../SW18-Lab3/layout.php?email=$email'>Vea sus opciones</a>");
					}
					else {
	...
	<footer class='main' id='f1'>
		<a href='https://github.com/Enya0/WS18C/tree/master/SW18-Lab3'>Link GITHUB</a>
	</footer>
</div>
</body>
</html>